...
export default function Collection({ title, items }: CollectionT) {
  // Updated ref type to allow null values
  const card = useRef<HTMLAnchorElement | null>(null); // Allow null
  ...
  return (
    <div className="collection">
      ...
      <div className="collection-slider">
        ...
        >
          {items.map((item, i) => {
            // Pass Ref (with capital R) to the first card, others will get undefined
